...
{JSON.stringify(
  {
    ...
    counts: { findings: findings.length, experiments: experiments.length, impacts: impacts.length },
  },
  null,
  2
)}
      ...
      {(!me || !orgId) && (
        <section style={{ marginTop: 8, padding: 12, border: "1px solid #eee", borderRadius: 8 }}>
          ...
          <p style={{ marginTop: 8, fontSize: 12, opacity: 0.8 }}>
            ...
            npx convex dev in one terminal and npm run dev in another. Restart both after schema or server changes.
          </p>
        </section>
      )}
